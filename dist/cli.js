...
const displayDashboard_1 = require("./displayDashboard");
...
const handleGuardianChecksCommand = (options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, displayDashboard_1.displayDashboard)(resultsByCategory);
...
const setAwsProfile = (command) => {
    ...
    if (process.env.AWS_PROFILE === undefined) {
        process.env.AWS_PROFILE = (_a = process.env.DEFAULT_AWS_PROFILE) !== null && _a !== void 0 ? _a : 'default';
    }
};
