...
const fetchResourceArns = (cloudformations, tags) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const resourcesFetchedByTags = yield (0, helpers_1.fetchTaggedResourceArns)(tags !== null && tags !== void 0 ? tags : []);
        ...
        const resources = (0, intersectionWith_1.default)(resourcesFetchedByStack, resourcesFetchedByTags, (arnA, arnB) => arnA.resource === arnB.resource && arnA.service === arnB.service);
